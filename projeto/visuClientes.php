...
<body>
	...
	<div id="principal">
		<form method="POST" action="pesquisaC.php">
			<input type="text" name="select" placeholder="Digite o nome do cliente">
			<button id="one"><i class="fa fa-search fa-lg"></i></button>
			<button id="two"><a href="clientes.php">Voltar</a></button>
		</form>
		<table>
				<tr>
					<th>Nome</th>
